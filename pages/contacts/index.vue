<template>
	<div class="">
		...
		<div
			...
			ref="scrollableRef"
			class="flex flex-col max-h-[calc(100vh-144px)] overflow-y-auto scrollable mr-0.25"
		>
			<div v-for="(items, letter) in groupedContacts" :key="letter">
				...
				<div class="flex flex-col">
					<div v-for="(item, index) in items" :key="item._id" class="flex items-center justify-between cursor-pointer pl-6 duration-300 hover:bg-background-700">
									...
									>
										<div class="flex flex-col">
											...
											>
												...
												<Icon :name="item?.isFavorite ? 'ic:baseline-favorite-border' : 'ic:baseline-favorite'" size="16" class="text-secondary-400" />
											</div>
											<div
